...
function Sidebar() {
    const sidebarItems = ['home','browse','settings','myAnimeList','socials']
    return (
        <div className="h-full flex flex-col p-4">
           {sidebarItems.map((itm, index) => {
            return (
                <div key={index} className="p-4 rounded-md text-2xl">{itm}</div>
            )
           })}
        </div>
    )
  ...
  return (
    <html lang="en">
      <body>
        <div className=''>
        <Header />
        <div className='w-screen flex flex-col md:flex-row h-full'>
            <Sidebar />
            {children}
        </div>
        <Footer />
